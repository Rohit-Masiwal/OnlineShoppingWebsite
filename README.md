...
3. Download project from github(https://github.com/Rohit-Masiwal/OnlineShoppingWebsite.git)
    OR follow gitbash commands
    
    i>cd C:\\xampp\htdocs\
    
    ii>git clone https://github.com/Rohit-Masiwal/OnlineShoppingWebsite.git
